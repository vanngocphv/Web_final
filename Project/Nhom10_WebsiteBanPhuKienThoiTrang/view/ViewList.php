...
<body onload="onLoadCookie()">
                    ...
                    <ul class="nav navbar-nav">
                       ...
                       <?php
                       		...
                       		if ($get == "AO"){
                            	...
                            	echo '<a style = "background-color: black" href="ViewShop.php?Page=AO">Áo</a>';
                            	...
                            	echo '<a style = "background-color: black" href="ViewShop.php?Page=QUAN">Quần</a>';
                            	echo '<a href="ViewShop.php?Page=KHAC">Balo - Giày</a>';
                          		echo '</div>';
                          	}
                       		else{
                            	...
                            	echo '<a href="ViewShop.php?Page=AO">Áo</a>';
                            	echo '<a href="ViewShop.php?Page=QUAN">Quần</a>';
                            	echo '<a style = "background-color: black" href="ViewShop.php?Page=KHAC">Balo - Giày</a>';
                          		echo '</div>';
                          	}
                ...
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                    	<?php
                    		$PAGE = $_GET['Page'];
                    		if ($PAGE == "AO"){
                        		echo '<h2 style="font-family: Times New Roman;">Cửa hàng Áo</h2>';
        					}

                    		else if ($PAGE == "QUAN"){
                        		echo '<h2 style="font-family: Times New Roman;">Cửa hàng Quần</h2>';
        					}
                    		else{
                        		echo '<h2 style="font-family: Times New Roman;">Cửa hàng Balo - Giày</h2>';
        					}
        		?>
                    </div>
                </div>
	...
	if ($Lists == "X"){}
		...
		foreach ($Lists as $ID_Pro => $Pro)
		{
        	...
        	echo '<img src="'.$Pro->IMG.'" alt="" style="height:345px;width:480px">';
                ...
                <div class="col-md-12">
                    <div class="product-pagination text-center">
						...
						<?php
                            ...
                            echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=1">1</a></li>';
                            echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=2">2</a></li>';
							echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=3">3</a></li>';
							echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=4">4</a></li>';
							echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=5">5</a></li>';
							echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=6">6</a></li>';
							echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=7">7</a></li>';
							echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=8">8</a></li>';
							echo '<li><a href="ViewShop.php?Page='.$typePage.'&Trang=9">9</a></li>';
